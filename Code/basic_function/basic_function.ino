...
void updateMotors() {
  switch ( modeValue ) {
    ...
    case 4: pendulum(60, ch1Value, ch2Value); break;  // Alternating left-right vibes fast
    case 5: pendulum(20, ch1Value, ch2Value); break;  // Alternating left-right vibes fast
    case 6: triangle(30, ch1Value, ch2Value ); break;  // aattack/decay on both channels
    case 7: triangle(60, ch1Value, ch2Value ); break;  // aattack/decay on both channels
    case 8: saw(60, ch1Value, ch2Value ); break;  // aattack/decay on both channels
